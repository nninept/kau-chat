...
function Notice() {
  ...
  return (
    <div className="Notice">
      ...
      <NoticeForm noticeInfo={{korean : "일반공지", english : "General Notice"}} noticeList={generalNotiList} category={"general"}/>
      <NoticeForm noticeInfo={{korean : "학사공지", english : "Academic Notice"}} noticeList={schoolNotiList} category={"general"}/>
    </div>
  );
}
